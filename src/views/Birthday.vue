...
<template>
  ...
  <main class="min-h-screen bg-[#f2eedc] pt-28 pb-20 font-serif">
    <header class="text-center mb-12">
      <h1 class="text-3xl tracking-[0.6em] text-[#002B40] mb-2 font-medium">生日寫真</h1>
      <p class="text-xs uppercase tracking-[0.3em] text-[#002B40] opacity-60">Birthday Portfolio</p>
    </header>
